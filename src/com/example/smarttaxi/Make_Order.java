...
public class Make_Order extends AsyncTask<JSONObject, String, JSONObject>{
	...
	protected JSONObject doInBackground(JSONObject... JS) {
		...
		try {
			...
			HttpPost httppost = new HttpPost("http://smarttaxi.newton-innovations.kz/php/orders.php");
